...
class HomeController extends Controller
{
    ...
    {                                
        ...
        $current_year=Carbon::now()->format('Y');
            ...
            $tot_incomes_month=Operation::whereYear('date', '=', $today->year)
                            ->whereMonth('date', '=', $today->month)->sum('amount');
            $tot_expenses_month=Expense::whereYear('date', '=', $today->year)
                            ->whereMonth('date', '=', $today->month)->sum('amount');
    ...
    public function load_graph_om($month){
    ...
    public function load_graph_mm($month){
