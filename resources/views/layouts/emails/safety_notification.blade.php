                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                        <tr>
                            <td style="padding: 15px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                ...
                                <p>Le notificamos que el siguiente producto a caído en condición de <b>Stock Mínimo</b>.</p>
                                ...
                                <p>
                                    ...
                                    <strong>Stock mínimo establecido:</strong> {{ $product->safety_stock }}
                                </p>
                                
                                <p>Le sugerimos haga su pedido de reposición para evitar que el producto se agote.</p>
