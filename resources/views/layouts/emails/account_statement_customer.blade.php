                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                        <tr>
                            <td style="padding: 15px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                ...
                                <p>Estimado(a) <b>{{ $customer->name }}.</b></p>

                                <p>Le informamos que actualmente tiene una deuda de <b><span class="symbols">{{ Session::get('coin') }}</span> {{ money_fmt($pending_sales->sum('balance')) }}</b>
                                                            
                                <p>Adjunto le enviamos el archivo de su {{ ($type=='F')?'estado de cuenta':'resumen de apartado' }}.</p>
